...
public class Model_Client_Mail implements GEntity{
    LogWrapper logwrapr = new LogWrapper("Model_Client_Mail", "cas-error.log");
    
    private final String XML = "Model_Client_eMail_Address.xml";
    ...
    public Model_Client_Mail(GRider value) {
        if (value == null) {
    ...
    public JSONObject newRecord() {
        ...
        setEmailId(MiscUtil.getNextCode(getTable(), "sEmailIDx", true, poGRider.getConnection(), ""));
    ...
    public JSONObject openRecord(String barangayId) {
        ...
        lsSQL = MiscUtil.addCondition(lsSQL, "sEmailIDx = " + SQLUtil.toSQL(barangayId));

...
public class Model_Client_Social_Media implements GEntity{
    LogWrapper logwrapr = new LogWrapper("Model_Client_Social_Media", "cas-error.log");
    
    private final String XML = "Model_Client_Social_Media.xml";
    ...
    public Model_Client_Social_Media(GRider value) {
        if (value == null) {
    ...
    public JSONObject newRecord() {
        ...
        setSocMedId(MiscUtil.getNextCode(getTable(), "sSocialID", true, poGRider.getConnection(), ""));
    ...
    public JSONObject openRecord(String barangayId) {
        ...
        lsSQL = MiscUtil.addCondition(lsSQL, "sSocialID = " + SQLUtil.toSQL(barangayId));
        ...
        if (pnEditMode == EditMode.ADDNEW || pnEditMode == EditMode.UPDATE) {
            ...
            if (pnEditMode == EditMode.ADDNEW) {
                ...
                if ("success".equals((String) loJSON.get("result"))) {
                    //replace the condition based on the primary key column of the record
                    lsSQL = MiscUtil.makeSQL(this, loOldEntity, "sSocialID = " + SQLUtil.toSQL(this.getSocMedId()));

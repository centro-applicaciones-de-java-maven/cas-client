...
//import javafx.fxml.Initializable;a
...
//
//public class IndividualNewControllerx implements Initializable {
...
//                                AddressField03.clear();
//                            } else {
//                                AddressField03.setText((String) loProvince.getModel().getDescription());
...
//                                AddressField04.clear();
//                            } else {
//                                AddressField04.setText((String) loTownCity.getModel().getDescription());
...
//
//                personalinfo08.setText(loTownCity.getModel().getDescription()+ ", " + loProvince.getModel().getDescription());
//            }
...
//
//                AddressField03.setText(loProvince.getModel().getDescription());
//
//                TownCity loTownCity = new TownCity();
//                loTownCity.setApplicationDriver(oApp);
//                loTownCity.setRecordStatus("1");

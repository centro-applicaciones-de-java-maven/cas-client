...
public class AR_Client_Ledger extends Parameter{
    //object model
    Model_AR_Client_Ledger poModel;
...
//    }
    ...
    public void initialize() {
        ...
        poModel = new Model_AR_Client_Ledger();
        poModel.setApplicationDriver(poGRider);
        poModel.setXML("Model_AR_Client_Ledger");
        poModel.setTableName("AR_Client_Ledger");
        poModel.initialize();

...
// * @author 
// */
//public class Account_Accreditationx implements GTransaction {
//
//    GRider poGRider;
//    boolean pbWthParent;
//    int pnEditMode;
...
//        return psTransNox;
//    }
//    public Account_Accreditationx(GRider foGRider, boolean fbWthParent) {
//        poGRider = foGRider;
...
//                
//            }
////            ValidatorInterface validator = ValidatorFactory.make(ValidatorFactory.TYPE.Account_Accreditationx, poModel.get(lnCtr));
